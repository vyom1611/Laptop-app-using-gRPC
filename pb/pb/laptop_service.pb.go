...
var file_laptop_service_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x4a, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4c, 0x61, 0x70, 0x74, 0x6f,
	0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x33, 0x0a, 0x06, 0x6c, 0x61, 0x70, 0x74,
	0x6f, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x76, 0x79, 0x6f, 0x6d, 0x31,
	0x36, 0x31, 0x31, 0x2e, 0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x5f, 0x61, 0x70, 0x70, 0x2e, 0x4c,
	...
	0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0x76, 0x0a, 0x0d, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x53,
	...
	0x74, 0x6f, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x06, 0x5a,
...
var file_laptop_service_proto_goTypes = []interface{}{
	...
	(*Laptop)(nil),               // 2: vyom1611.laptop_app.Laptop
}
var file_laptop_service_proto_depIdxs = []int32{
	2, // 0: vyom1611.laptop_app.CreateLaptopRequest.laptop:type_name -> vyom1611.laptop_app.Laptop
	0, // 1: vyom1611.laptop_app.LaptopService.CreateLaptop:input_type -> vyom1611.laptop_app.CreateLaptopRequest
	1, // 2: vyom1611.laptop_app.LaptopService.CreateLaptop:output_type -> vyom1611.laptop_app.CreateLaptopResponse
...
func (c *laptopServiceClient) CreateLaptop(ctx context.Context, in *CreateLaptopRequest, opts ...grpc.CallOption) (*CreateLaptopResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/vyom1611.laptop_app.LaptopService/CreateLaptop", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LaptopService_CreateLaptop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vyom1611.laptop_app.LaptopService/CreateLaptop",
	}
...
var _LaptopService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "vyom1611.laptop_app.LaptopService",
